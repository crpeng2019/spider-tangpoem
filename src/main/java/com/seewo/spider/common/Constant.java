package com.seewo.spider.common;
...
public class Constant {
    ...
    public static final String POET_ID_API = "http://poem.studentsystem.org/web/sc/zuozhe/all";
    public static final String POET_DETAILS_API = "http://poem.studentsystem.org/web/sc/zuozhe/get?id=";
    public static final String POEM_DETAILS_API = "http://poem.studentsystem.org/shici?id=";
    public static final String POEM_DETAILS_UNFIXED_TITLE_VALUE = "{{ biaoti }}";
    public static final String MONGODB_CONFIG_PATH = "/mongodb.properties";
    public static final String SPIDER_CONFIG_PATH = "/spider.properties";
    public static final String POEM_DETAILS_KEY = "poemDetails";
    public static final String POET_DETAILS_KEY = "poetDetails";

    public static final Integer MILLIS_PER_SECOND = 1000;
    public static final Integer MILLIS_PER_MINUTE = 60 * 1000;
    public static final Integer MILLIS_PER_HOUR = 60 * 60 * 1000;
    ...
    public static String getAgent() {
        return Constant.AGENTS[new Random().nextInt(Constant.AGENTS.length)];
    }
}
